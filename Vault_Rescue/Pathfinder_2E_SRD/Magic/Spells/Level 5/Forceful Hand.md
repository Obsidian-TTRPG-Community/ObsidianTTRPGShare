...
- **Grasp** The hand Flies to an enemy of your choice within range and attempts to [Grapple](../../../Actions/Grapple.md) that enemy, using your spell attack roll instead of an Athletics check to determine the results of the Grapple.
