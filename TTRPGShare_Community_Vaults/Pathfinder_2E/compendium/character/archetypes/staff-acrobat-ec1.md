...
*Source: Extinction Curse #1: The Show Must Go On p. 75*  
%% #trait/uncommon #trait/archetype #trait/flourish %%
```  
...
*Source: Extinction Curse #1: The Show Must Go On p. 75*  
%% #trait/uncommon #trait/archetype #trait/press %%
```  
...
*Source: Extinction Curse #1: The Show Must Go On p. 75*  
%% #trait/uncommon #trait/archetype #trait/flourish #trait/stance %%
```  
...
*Source: Extinction Curse #1: The Show Must Go On p. 75*  
%% #trait/uncommon #trait/archetype #trait/attack #trait/open %%
```