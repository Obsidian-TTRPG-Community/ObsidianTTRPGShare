...
aliases: ["Sleepwalker"]
---
# Sleepwalker *Dedication Level 4*  
...
*Source: Dark Archive p. 206*  
%% #trait/archetype #trait/enchantment #trait/mental #trait/occult %%
```  
...
*Source: Dark Archive p. 206*  
%% #trait/archetype #trait/divination #trait/fortune #trait/occult %%
```  
...
*Source: Dark Archive p. 206*  
%% #trait/archetype #trait/enchantment #trait/incapacitation #trait/mental #trait/occult %%
```  
...
%% #trait/abjuration #trait/archetype #trait/occult %%
```  
