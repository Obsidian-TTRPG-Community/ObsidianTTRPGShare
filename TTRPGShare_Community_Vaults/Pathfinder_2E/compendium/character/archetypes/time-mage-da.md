...
*Source: Dark Archive p. 185*  
%% #trait/archetype #trait/concentrate #trait/metamagic %%
```  
...
%% #trait/divination #trait/exploration #trait/oracle #trait/prediction %%
```  
...
%% #trait/bard #trait/concentrate #trait/metamagic %%
```  
...
*Source: Dark Archive p. 185*  
%% #trait/archetype #trait/concentrate #trait/divination #trait/manipulate #trait/metamagic %%
```  
