...
When you use this action, attempt an [Intimidation](/compendium/skills.md#Intimidation) check. The DC is usually a standard-difficulty DC of your level, but the GM can assign a different DC based on the circumstances.
...
*Source: Advanced Player's Guide p. 180*  
%% #trait/archetype #trait/auditory #trait/flourish %%
```  
...
*Source: Advanced Player's Guide p. 180*  
%% #trait/archetype #trait/open #trait/visual %%
```  
