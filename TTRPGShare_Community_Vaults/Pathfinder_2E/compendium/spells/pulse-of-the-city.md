...
- Masses common folk and merchants (gathering mobs, major sales) When uttering your word, you can exclude events you already know about, whether you know about them from this spell or from other experiences. If you cast [pulse of the city](/compendium/spells/pulse-of-the-city.md) again within 24 hours, you can say "echo" instead of another word to get an update on the event you learned about the last time you [Cast the Spell](/rules/actions/cast-a-spell.md)
