...
Casting veil counts as setting up a disguise for the purpose of the [Impersonate](/rules/actions/impersonate.md) action. It allows the target to ignore any circumstance penalties they might take for being disguised as dissimilar creatures, and it gives the targets a +4 status bonus to [Deception](/compendium/skills.md#Deception) checks to prevent others from seeing through their disguises, and add their level even if untrained. You can [Dismiss](/rules/actions/dismiss.md) any or all of these disguises.
