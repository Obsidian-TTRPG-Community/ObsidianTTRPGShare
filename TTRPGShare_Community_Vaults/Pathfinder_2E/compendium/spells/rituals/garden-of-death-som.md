...
> [!success-degree] 
> - **Critical Success** A poisonous garden forms, and you and the secondary casters gain a +2 circumstance bonus to [Nature](/compendium/skills.md#Nature) or [Crafting](/compendium/skills.md#Crafting) checks to deal with the plants or animals, such as feeding them or harvesting poison from them.
