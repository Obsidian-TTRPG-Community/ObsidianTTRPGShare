...
Poisons attack specific parts of the body—one venom might target the lungs, another the circulatory system, while another deteriorates the nerves. You know how to take advantage of such weaknesses. You deal `1d6` damage of the required [Strike](/rules/actions/strike.md)'s damage type and `1d6` poison damage to the target. If you're at least 18th level, you deal `2d6` damage of each type.
