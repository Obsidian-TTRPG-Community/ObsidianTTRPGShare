...
Using your body, a lever, or some other tool, you attempt to forcefully open a door, window, container or heavy gate. With a high enough result, you can even smash through walls. Without a [crowbar](../../TTRPGShare_Community_Vaults/Pathfinder_2E/equipment/items/crowbar.md), prying something open takes a –2 item penalty to the [Athletics](/compendium/skills.md#Athletics) check to Force Open.
