...
**6** embody the magical veins and arteries of the multiverse, flowing with energy across worlds and planes alike and gathering at special locations called nodes. Spellcasters can learn to tap into ley lines, though doing so presents a significant gamble.
...
These elemental focus spells are available to druids of the flame, stone, and wave orders and to characters with the [elementalist](../../TTRPGShare_Community_Vaults/Pathfinder_2E/character/archetypes/elementalist-som.md) class archetype.
...
### [Elementalist](../../TTRPGShare_Community_Vaults/Pathfinder_2E/character/archetypes/elementalist-som.md) (Class Archetype)
<sup>SoM p. 206</sup>
...
### [Flexible Spellcaster](../../TTRPGShare_Community_Vaults/Pathfinder_2E/character/archetypes/flexible-spellcaster-som.md) (Class Archetype)
<sup>SoM p. 209</sup>
...
### [Geomancer](../../TTRPGShare_Community_Vaults/Pathfinder_2E/character/archetypes/geomancer-som.md) (Archetype)
<sup>SoM p. 212</sup>
...
- [Energy Scarred](../../TTRPGShare_Community_Vaults/Pathfinder_2E/character/backgrounds/energy-scarred-som.md)
- [Mystic Tutor](../../TTRPGShare_Community_Vaults/Pathfinder_2E/character/backgrounds/mystic-tutor-som.md)
- [Surge Investigator](../../TTRPGShare_Community_Vaults/Pathfinder_2E/character/backgrounds/surge-investigator-som.md)
...
**[Shadowcasters](../../TTRPGShare_Community_Vaults/Pathfinder_2E/character/archetypes/shadowcaster-som.md)** sacrifice the magic of light to bind themselves to the darkness. Information about shadowcasters in the Inner Sea region can be found on this page and the [archetype](../../TTRPGShare_Community_Vaults/Pathfinder_2E/character/archetypes/shadowcaster-som.md).

**Shadow companions and familiars** can accompany shadowcasters or can join anyone else as shadowy compatriots. These creatures might follow one who's already traveling the path of shadow or might be strange ambassadors to someone of a more conventional stripe. [Shadowdancers](../../TTRPGShare_Community_Vaults/Pathfinder_2E/character/archetypes/shadowdancer-apg.md) with companions typically choose these creatures of shadow.
...
> [!pf2-note]
> You can find the full [Shadowcaster](../../TTRPGShare_Community_Vaults/Pathfinder_2E/character/archetypes/shadowcaster-som.md) archetype on the archetypes page.

### Shadow Companions
<sup>SoM p. 228</sup>

Spellcasters aren't the sole purveyors of shadow magic. Some adventurers are guided on their path by companions with an inherent connection to shadow, whether or not the adventurer is a shadowcaster. Adventurers who would wield shadow should follow the guidance of such beings. [Shadowcasters](../../TTRPGShare_Community_Vaults/Pathfinder_2E/character/archetypes/shadowcaster-som.md), as well as others who might stumble across this knowledge, have access to the shadow hound animal companion and the shade specialization option.
...
> <sup>SoM p. 233</sup>
> 
> You can turn a specific item into your armament, such as a [flame tongue](../../TTRPGShare_Community_Vaults/Pathfinder_2E/equipment/items/flame-tongue.md) or [sturdy shield](../../TTRPGShare_Community_Vaults/Pathfinder_2E/equipment/items/sturdy-shield.md), though some unusual or special items can't be bonded, such as cursed items, artifacts, and intelligent items, in addition to other story-specific items at the GM's discretion. Bonding a specific item follows the standard procedure for upgrading or reshaping your armament.
> 
> ### Ammunition
> <sup>SoM p. 233</sup>
> 
> If a soulforged weapon requires ammunition, that ammunition appears with the weapon when you Manifest it. You can choose the way it appears, such as in a magical quiver that appears on your body, or simply floating in the air where you can pluck it to load or shoot your weapon. The form doesn't change how many or what type of actions reloading takes or any other functions of the ammunition. If you want anything other than basic ammunition for your weapon (such as a [sleep arrow](../../TTRPGShare_Community_Vaults/Pathfinder_2E/equipment/items/sleep-arrow.md)), you must attain and carry that ammunition separately.
> 
> ### Dual Weapons
> <sup>SoM p. 233</sup>
> 
...
> [!pf2-note]
> You can find the [Soulforger](../../TTRPGShare_Community_Vaults/Pathfinder_2E/character/archetypes/soulforger-som.md) archetype on the archetypes page.
...
> [!pf2-note]
> You can find the full [Runelord](../../TTRPGShare_Community_Vaults/Pathfinder_2E/character/archetypes/runelord-som.md) archetype on the archetypes page.
...
> [!pf2-note]
> You can find the [Wellspring Mage](../../TTRPGShare_Community_Vaults/Pathfinder_2E/character/archetypes/wellspring-mage-som.md) archetype on the archetypes page.
