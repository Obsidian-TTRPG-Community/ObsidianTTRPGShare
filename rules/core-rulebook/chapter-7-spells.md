...
> 
> If you're a bard [Casting a Spell](/rules/actions/cast-a-spell.md) from the [occult](/rules/traits/occult.md) tradition you can usually play an [instrument](../../TTRPGShare_Community_Vaults/Pathfinder_2E/equipment/items/musical-instrument.md) for spells requiring somatic or material components, as long as it takes at least one of your hands to do so. If you use an instrument, you don't need a spell component pouch or another hand free. You can usually also play an instrument for spells requiring verbal components, instead of speaking.
> 
> If you're a cleric [Casting a Spell](/rules/actions/cast-a-spell.md) from the [divine](/rules/traits/divine.md) tradition while holding a divine focus (such as a religious symbol or [text](../../TTRPGShare_Community_Vaults/Pathfinder_2E/equipment/items/religious-text.md)), you can replace any material component the spell requires by using the divine focus as a focus component instead. Unlike the normal rules for a focus component, you can't retrieve or stow the focus when making this substitution.
> 
> If you're a druid [Casting a Spell](/rules/actions/cast-a-spell.md) from the [primal](/rules/traits/primal.md) tradition while holding a primal focus (such as [holly and mistletoe](../../TTRPGShare_Community_Vaults/Pathfinder_2E/equipment/items/holly-and-mistletoe.md)), you can replace any material component the spell requires by using the primal focus as a focus component instead. Unlike the normal rules for a focus component, you can't retrieve or stow the focus when making this substitution.
> 
