...
gear:
  - name: combat
    desc: potion of cure light wounds, potions of invisibility (2), thunderstones (4)
  - name: other
    desc: shuriken (10), 7 gp
ecology:
  - name: Environment
...
# Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Duergar%20Anvil)
```encounter-table
name: Duergar Anvil
creatures:
  - 1: Duergar Anvil
