...
speed: 60 ft.
melee: mwk dagger +13/+8 (1d4+5/19-20 plus 2d6 fire), mwk dagger +13/+8 (1d4+5/19-20 plus 2d6 fire)
...
ecology:
  - name: Environment
    desc: any warm land (Plane of Fire)
  - name: Organisation
...
spell-like_abilities:
  ...
  - name: At will
    desc: resist energy, scorching ray
  - name: 3/day
    desc: cure serious wounds, suggestion (DC 18)
  - name: 1/day
    desc: dispel magic, fire snake (DC 20)
sources:
  - name: Bestiary 5
    desc: 265
...
## Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Fire%20Veela)
```encounter-table
name: Fire Veela
creatures:
  - 1: Fire Veela
