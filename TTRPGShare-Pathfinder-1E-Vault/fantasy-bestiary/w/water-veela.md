...
melee: mwk dagger +13/+8 (1d4+5/19-20 plus 1d6 cold), mwk dagger +13/+8 (1d4+5/19-20 plus 1d6 cold)
...
spell-like_abilities:
  ...
  - name: At will
    desc: hydraulic push, resist energy
  - name: 3/day
    desc: cure serious wounds, suggestion (DC 18)
  - name: 1/day
    desc: cone of cold (DC 20), dispel magic
sources:
  - name: Bestiary 5
    desc: 265
...
## Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Water%20Veela)
```encounter-table
name: Water Veela
creatures:
  - 1: Water Veela
