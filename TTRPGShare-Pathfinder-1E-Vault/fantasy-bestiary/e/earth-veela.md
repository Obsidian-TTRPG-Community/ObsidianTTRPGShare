...
SR: 18
speed: 30 ft.
melee: mwk dagger +13/+8 (1d4+5/19-20 plus 1d6 bludgeoning), mwk dagger +13/+8 (1d4+5/19-20 plus 1d6 bludgeoning)
special_attacks: beckoning dance, elemental veil
pf1e_stats: [20, 17, 19, 14, 11, 20]
BAB: 9
CMB: 14
CMD: 27
...
ecology:
  - name: Environment
    desc: any mountains or underground (Plane of Earth)
  - name: Organisation
    desc: solitary, pair, or troupe (3-6)
  - name: Treasure
    desc: standard (2 mwk daggers)
special_abilities:
  - name: Beckoning Dance (Su)
...
spell-like_abilities:
  ...
  - name: At will
    desc: stoneskin, stone call
  - name: 3/day
    desc: cure serious wounds, suggestion (DC 18)
  - name: 1/day
    desc: dispel magic, transmute rock to mud
sources:
  - name: Bestiary 5
    desc: 264
desc_short: This lithe, androgynous humanoid has unusually colored skin and an otherworldly grace.
```
## Description

## Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Earth%20Veela)
```encounter-table
name: Earth Veela
creatures:
  - 1: Earth Veela
