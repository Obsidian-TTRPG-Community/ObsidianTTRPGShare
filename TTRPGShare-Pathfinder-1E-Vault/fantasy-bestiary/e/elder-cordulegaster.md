...
melee: bite +14 (2d6+9 plus grab and pull), tail slap +9 (1d8+3)
special_attacks: extending jaw, gnaw, powerful bite, pull (bite, 10 ft.), stygian bite (Will DC 15)
space: 10 ft.
reach: 10 ft. (15 ft. with bite)
pf1e_stats: [23, 11, 19, 12, 14, 8]
BAB: 9
CMB: 16 (+20 grapple)
CMD: 26
feats: Ability Focus (stygian bite), Alertness, Improved Initiative, Improved Natural Attack (bite), Lightning Reflexes
skills: Climb +15, Intimidate +8, Knowledge (planes) +6, Perception +16, Sense Motive +11, Stealth +8, Survival +14, Swim +26, Use Magic Device +11
racial_modifiers:
- Stealth 5
languages: Abyssal (can’t speak), Draconic (can’t speak), Infernal (can’t speak), telepathy 100 ft.
ecology:
  - name: Environment
...
spell-like_abilities:
  ...
  - name: At will
    desc: healing thief (DC 13)
  - name: 3/day
    desc: aqueous orb (DC 13), hydraulic torrent
  - name: 1/day
    desc: confusion (DC 14), summon
sources:
  - name: Pathfinder No. 98: Turn of the Torrent
    desc: 83
desc_short: The insectile eyes of this chitin-covered daemonic monstrosity display a malign intelligence.
```
## Description

## Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Elder%20Cordulegaster)
```encounter-table
name: Elder Cordulegaster
creatures:
  - 1: Elder Cordulegaster
```
