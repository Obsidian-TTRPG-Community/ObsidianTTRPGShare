...
special_attacks: constrict (2d8+4 plus 2d6 negative energy), negatively charged cells
pf1e_stats: [17, 19, None, 2, 11, 12]
BAB: 8
CMB: 11 (+15 grapple)
...
special_abilities:
  ...
  - name: Negatively Charged Coils (Su)
    desc: A hollow serpent deals an additional 2d6 points of damage caused by negative energy to victims trapped within its coils. A successful DC 16 Will save reduces the damage by half. The save DC is Charisma-based.
...
# Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Lesser%20Hollow%20Serpent)
```encounter-table
name: Lesser Hollow Serpent
creatures:
  - 1: Lesser Hollow Serpent
```
