...
pf1e_stats: [18, 17, 16, None, 13, 2]
BAB: 5
CMB: 10
CMD: 23
feats: Improved Initiative, Lightning Reflexes
skills: Swim +12, Perception +1
...
special_abilities:
  - name: Poison (Ex)
    desc: Sting-injury; save Fort DC 16; frequency 1/round for 6 rounds; effect 1d4 Con; cure 2 consecutive saves.
...
# Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Bluetip%20Eurypterid)
```encounter-table
name: Bluetip Eurypterid
creatures:
  - 1: Bluetip Eurypterid
```
