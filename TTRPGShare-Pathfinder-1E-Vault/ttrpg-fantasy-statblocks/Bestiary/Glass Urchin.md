...
defensive_abilities: stability, transparency
speed: 5 ft.
melee: 3 spines +17 (1d8+10 plus poison)
special_attacks: poison spray, spines
space: 15 ft.
reach: 15 ft.
pf1e_stats: [31, 3, 22, None, 15, 2]
BAB: 9
CMB: 21
CMD: 27 (35 vs. bull rush or trip)
skills: Perception +6
racial_modifiers:
- Perception 4
...
special_abilities:
  ...
  - name: Poison (Ex)
    desc: Glass urchin venom causes the senses to become clouded and creates vivid hallucinations and confusion in the victim’s mind. The save DC is Constitution-based.
...
# Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Glass%20Urchin)
```encounter-table
name: Glass Urchin
creatures:
  - 1: Glass Urchin
