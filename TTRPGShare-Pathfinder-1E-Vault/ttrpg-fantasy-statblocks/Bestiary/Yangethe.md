...
special_attacks: feeding tentacles, psychic blast
space: 10 ft.
reach: 10 ft.
pf1e_stats: [24, 18, 22, 17, 21, 17]
BAB: 8
CMB: 16 (+20 grapple)
...
skills: Knowledge (arcana) +14, Knowledge (geography) +14, Knowledge (engineering) +17, Perception +19, Sense Motive +16, Spellcraft +17, Use Magic Device +14
...
psychic_magic:
  ...
  - name: 20 PE
    desc: control summoned creature (PE4; DC17), demand (PE8; DC21), fear (PE4; DC17), quickened true strike (PE1)
spell-like_abilities:
  ...
  - name: Constant
    desc: air walk
  - name: At will
    desc: darkness, telekinesis (DC 18), tree shape
  - name: 1/year
