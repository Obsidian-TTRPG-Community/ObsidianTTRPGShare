...
melee: troop (4d6+3)
special_attacks: leap attack, swarming
space: 15 ft.
reach: 5 ft.
pf1e_stats: [17, 21, 16, 5, 14, 6]
BAB: 9
CMB: 12
CMD: 28
feats: Acrobatic, Dodge, Iron Will, Mobility, Toughness
skills: Acrobatics +18, Climb +25, Stealth +11, Perception +2
racial_modifiers:
- Acrobatics 8
- Climb 16
- Stealth 4
...
special_abilities:
  ...
  - name: Swarming (Ex)
    desc: Much of the morlock swarmer troop’s damage comes from sneak attacks made by its constituent members as they climb over one another, confusing their prey. Against creatures that cannot be flanked or that are immune to critical hits, sneak attacks, or precision-based damage, the morlock swarmer troop’s attack damage is reduced to 2d6.
sources:
