...
spells_prepared:
  ...
  - name: 5th
    desc: phantasmal killer (DC15), wall of thorns
  - name: 4th
    desc: displacement, freedom of movement, ice storm, spike stones (DC14)
  - name: 3rd
    desc: cure moderate wounds, ghoul touch (DC13), greater magic fang, poison (DC13), sleet storm
  - name: 2nd
    desc: 2xbarkskin, bear’s endurance, chill touch (DC12), resist energy
  - name: 1st
    desc: cure light wounds, entangle (DC11), longstrider, obscuring mist, speak with animals
  - name: 0 (at-will)
    desc: detect magic, guidance, purify food and drink, ray of frost
sources:
...
# Source Link
[Archives of Nethys](https://aonprd.com/NPCDisplay.aspx?ItemName=Uskwood%20Druid)
```encounter-table
name: NPC Uskwood Druid
creatures:
  - 1: NPC Uskwood Druid
