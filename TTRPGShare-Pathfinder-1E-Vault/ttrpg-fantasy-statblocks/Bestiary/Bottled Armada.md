...
melee: swarm (2d6+4 plus distraction)
special_attacks: distraction (DC 16)
pf1e_stats: [16, 17, None, 5, 14, 15]
BAB: 10
CMB: None
CMD: None
feats: Alertness, Improved Initiative, Lightning Reflexes, Skill Focus (Perception)
skills: Fly +20, Perception +15, Sense Motive +4
languages: understands Aquan and Common
special_qualities: shatter swarm
ecology:
  - name: Environment
    desc: any
  - name: Organisation
...
special_abilities:
  - name: Shatter Swarm (Ex)
    desc: Whenever a bottled armada fires its ballistae, swarms a creature, or is dealt weapon damage, one of the containing bottles shatters, spraying glass in a circle around it. All creatures in a 5-foot radius take 1d6 points of piercing damage. A successful DC 13 Reflex save (DC 13) halves the damage.
...
sources:
  - name: Pathfinder No. 57: Tempest Rising
    desc: 86
desc_short: A fleet of miniature ships, each secure in a glass bottle, flies through the air. The ships move as one, coordinating their attacks.
```
# Description

# Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Bottled%20Armada)
```encounter-table
name: Bottled Armada
creatures:
  - 1: Bottled Armada
