...
special_attacks: breath weapon (40-ft. cone, 6d6 bludgeoning and fire, Reflex DC 18 half, usable every 1d4 rounds), discorporate
space: 10 ft.
reach: 10 ft.
...
special_abilities:
  ...
  - name: Firesight (Ex)
    desc: An ossumental can see through fire and smoke as if they were transparent, ignoring any cover or concealment bonuses from fire and smoke, up to its normal range of vision.
...
# Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Ossumental%20(Fire))
```encounter-table
name: Ossumental (Fire)
creatures:
  - 1: Ossumental (Fire)
