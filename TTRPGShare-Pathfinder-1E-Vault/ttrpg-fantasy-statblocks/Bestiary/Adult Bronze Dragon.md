...
special_attacks: breath weapon (100-ft. line, DC 23, 12d6 electricity), crush, repulsion breath
space: 15 ft.
...
known_spells:
  - name:
    desc: (CL 7)
  - name: 3rd (5/day)
    desc: dispel magic, slow (DC18)
  - name: 2nd (7/day)
    desc: blur, gust of wind, mirror image
  - name: 1st (8/day)
...
spell-like_abilities:
  - name:
    desc: (CL 16)
  - name: At will
    desc: create food and water, fog cloud, speak with animals
sources:
