...
size: Huge
type: outsider
subtype: (air, elemental, extraplanar, mythic)
INI: +15
perception: +20
senses: darkvision
...
special_attacks: create vacuum, elevated ejection, fast swallow, mythic power (5/day, surge +1d8), swallow whole (2d8+9 bludgeoning damage, AC 14, 20 hp, DR 10/-), whirlwind (at will, 10-60 ft. high, 2d8+9 damage, DC 27)
space: 15 ft.
reach: 15 ft.
pf1e_stats: [28, 33, 18, 12, 13, 11]
BAB: 16
CMB: 27 (+31 grapple)
CMD: 49
...
special_abilities:
  - name: Air Mastery (Ex)
    desc: Airborne creatures take a -1 penalty on attack and damage rolls against a mythic air elemental.
  - name: Create Vacuum (Ex)
  ...
  - name: Elevated Ejection (Ex)
    desc: When a mythic air elemental in whirlwind form ejects a trapped creature, it can do so from any point up to the whirlwind’s current height, dropping the creature into the whirlwind’s space or within the elemental’s normal reach. The creature takes falling damage as normal. If the elemental expends one use of mythic power, it can instead throw a trapped creature as if using the uncanny grapple path ability (see page 23) with no grapple check needed.
  - name: Swallow Whole (Ex)
    desc: A mythic air elemental can use this ability on a creature it has grabbed. If a trapped creature cuts itself free, the hole heals itself closed at the start of the elemental’s next turn, allowing it to use swallow whole again.
sources:
