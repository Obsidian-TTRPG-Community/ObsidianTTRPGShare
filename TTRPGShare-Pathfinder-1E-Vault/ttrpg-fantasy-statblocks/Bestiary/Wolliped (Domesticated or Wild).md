...
statblock: inline
tags: monster
name: Wolliped (Domesticated or Wild)
---
```statblock
...
special_abilities:
  - name: Docile (Ex)
    desc: Unless a wolliped is specifically trained for combat (see the Handle Animal skill on page 97 of the Pathfinder RPG Core Rulebook), its gore is treated as a secondary attack and the creature lacks the trample ability.
  - name: Spit (Ex)
...
# Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Wolliped%20(Domesticated%20or%20Wild))
```encounter-table
name: Wolliped (Domesticated or Wild)
creatures:
  - 1: Wolliped (Domesticated or Wild)
```
