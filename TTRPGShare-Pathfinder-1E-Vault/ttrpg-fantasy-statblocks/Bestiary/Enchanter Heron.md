...
special_attacks: swallow whole (1d6 acid damage, AC 12, 3 hp)
space: 10 ft.
reach: 10 ft.
pf1e_stats: [18, 13, 14, 2, 13, 7]
BAB: 3
CMB: 8
CMD: 20
feats: Dodge, Flyby Attack, Hover
skills: Acrobatics +5, Fly +3, Perception +6, Swim +8
special_qualities: throat sack
ecology:
  - name: Environment
...
sources:
  - name: Pathfinder No. 121: The Lost Outpost
    desc: 82
desc_short: This large bird has gray-and-white feathers, a long beak, and a bulbous sac on its throat that glows with a pale, sapphire light.
```
# Description
...
# Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Enchanter%20Heron)
```encounter-table
name: Enchanter Heron
creatures:
  - 1: Enchanter Heron
