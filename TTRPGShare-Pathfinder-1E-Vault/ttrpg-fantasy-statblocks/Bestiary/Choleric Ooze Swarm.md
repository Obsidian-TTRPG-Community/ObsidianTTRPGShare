...
resist: acid 5
weak: vulnerability to electricity
speed: 10 ft.
melee: swarm (1 plus 1d4 acid and viscous)
special_attacks: corrosion, distraction (DC 15), viscous (DC 15)
space: 10 ft.
reach: 0 ft.
pf1e_stats: [16, 1, 19, None, 1, 1]
BAB: 2
CMB: -5
CMD: 8
skills: 
...
# Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Choleric%20Ooze%20Swarm)
```encounter-table
name: Choleric Ooze Swarm
creatures:
  - 1: Choleric Ooze Swarm
```
