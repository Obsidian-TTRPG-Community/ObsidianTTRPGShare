...
pf1e_stats: [10, 13, 15, 1, 13, 2]
BAB: 1
CMB: 1
CMD: 12
feats: Skill Focus (Perception)
skills: Perception +8, Stealth +5, Swim +8
racial_modifiers:
- Stealth 8
ecology:
  - name: Environment
...
special_abilities:
  - name: Poison (Ex)
    desc: Sting-injury; save Fort DC 13; frequency 1/round for 4 rounds; effect 1d2 Dex and 1 Con; cure 1 save. The save DC is Constitution-based.
...
sources:
  - name: Bestiary 2
    desc: 232
desc_short: A long tail fitted with a barbed stinger trails from this flat, triangular fish’s body.
```
# Description

# Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Stingray)
```encounter-table
name: Stingray
creatures:
  - 1: Stingray
