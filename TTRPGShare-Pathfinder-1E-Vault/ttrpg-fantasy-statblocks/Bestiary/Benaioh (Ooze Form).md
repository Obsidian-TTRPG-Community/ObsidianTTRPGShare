...
special_attacks: disease, engulf (DC 22, 6d6 acid plus disease)
space: 10 ft.
reach: 10 ft.
pf1e_stats: [26, 6, 23, None, 3, 1]
BAB: 6
CMB: 15
CMD: 23 (can’t be tripped)
skills: Climb +16, Swim +16, Perception -4
ecology:
  - name: Environment
...
special_abilities:
  - name: Disease (Ex)
    desc: While a benaioh is immune to disease, it carries a contagion with which it both infects other creatures and propagates itself. Any creature struck by the benaioh’s slam attack or engulf ability is exposed to this disease.
...
# Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Benaioh%20(Ooze%20Form))
```encounter-table
name: Benaioh (Ooze Form)
creatures:
  - 1: Benaioh (Ooze Form)
