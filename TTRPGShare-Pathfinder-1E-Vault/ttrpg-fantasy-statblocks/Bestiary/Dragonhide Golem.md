...
special_attacks: berserk, breath weapon (copper, red), powerful tail, rampage
space: 15 ft.
reach: 15 ft.
pf1e_stats: [34, 14, None, None, 11, 1]
BAB: 21
CMB: 35
CMD: 47
skills: 
special_qualities: draconic grafts (dragonlike senses, grafted head [copper], powerful tail)
ecology:
  - name: Environment
    desc: any
  - name: Organisation
...
d10Head TypeBreath Weapon1Black100-foot line of acid2Blue100-foot line of electricity3Brass100-foot line of fire4Bronze100-foot line of electricity5Copper100-foot line of acid6Gold50-foot cone of fire7Green50-foot cone of acid8Red50-foot cone of fire9Silver50-foot cone of cold10White50-foot cone of cold
  - name: Draconic Grafts
    desc: Dragonhide golems have several draconic grafts upon their giant bodies to enhance their abilities and defenses. Most dragonhide golems have three draconic grafts; however, the creator can add any number of additional grafts, with each additional graft beyond the third increasing the cost of the golem by 15,000 gp. For every two additional grafts beyond the third, the golem’s CR increases by 1. Unless otherwise noted, each draconic graft can be selected only once. Draconic grafts are chosen from those presented below.
...
Wings (Ex): A pair of dragon wings are grafted onto the golem’s back, granting a fly speed of 100 feet with clumsy maneuverability. This draconic graft can be selected up to four times. Each additional time this draconic graft is selected, it improves the golem’s fly speed by 50 feet and its maneuverability by one step, to a maximum fly speed of 250 feet with good maneuverability.
  - name: Immunity to Magic (Ex)
    desc: A dragonhide golem is immune to any spell or spell-like ability that allows spell resistance. In addition, certain spells and effects function differently against this creature, as noted below. A flesh to stone spell slows a dragonhide golem (as the slow spell) for 2d6 rounds, with no saving throw. A rage spell increases a dragonhide golem’s chance to go berserk by 50%, with no saving throw.
  - name: Rampage (Su)
    desc: Whenever a dragonhide golem goes berserk, its draconic grafts are temporarily empowered. It gains a +8 enhancement bonus to Strength, a +4 enhancement bonus to Dexterity, and a +4 enhancement bonus to natural armor. This effect ends when the golem’s berserk chance is reset to 0%.
sources:
  - name: Construct Handbook
    desc: 42
desc_short: This massive, hunched monstrosity has a hide that appears to be a mix of reptilian scales of various colors.
```
# Description
...
# Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Dragonhide%20Golem)
```encounter-table
name: Dragonhide Golem
creatures:
  - 1: Dragonhide Golem
