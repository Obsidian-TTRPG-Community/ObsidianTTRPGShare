...
AC: 44, touch 36, flat-footed 34 (deflection +4, dex +9, dodge +1, natural +8, profane +12)
HP: 604
HP_extra: regeneration 30; regeneration weakness deific or mythic
HD: 31d10+434
saves: Fort +28, Ref +32, Will +31
...
defensive_abilities: improved evasion, infernal resurrection, mind blank
SR: 37
...
special_attacks: barbed beard, bleed (2d6), counterport, festering filth
pf1e_stats: [30, 29, 38, 29, 30, 31]
BAB: 31
CMB: 41 (+45 trip)
CMD: 77 (79 vs. trip)
...
skills: Acrobatics +40, Bluff +44, Diplomacy +41, Handle Animal +44, Intimidate +41, Knowledge (arcana) +40, Knowledge (religion) +40, Knowledge (nature) +43, Knowledge (planes) +43, Linguistics +43, Perception +44, Sense Motive +44, Spellcraft +43, Stealth +43, Use Magic Device +41
languages: all (language mastery), speak with animals, telepathy 300 ft.
special_qualities: change shape (animal, humanoid, and magical beast; shapechange), hear name, sphere of souls
ecology:
  - name: Environment
    desc: any (Hell)
  - name: Organisation
  ...
  - name: Treasure
    desc: triple (Eyjatas, other treasure)
special_abilities:
  - name: Barbed Beard (Ex)
    desc: The bleeding caused by Barbatos's slashing beard requires a successful DC 39 Heal check (or caster level check, for magical healing) to stanch. The save DC is Constitution-based.
  - name: Counterport (Su)
