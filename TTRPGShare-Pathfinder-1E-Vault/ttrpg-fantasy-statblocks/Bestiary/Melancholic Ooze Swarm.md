...
special_attacks: distraction (DC 15), paralyzing slime, viscous (DC 15)
space: 10 ft.
reach: 0 ft.
pf1e_stats: [14, 1, 18, None, 1, 1]
BAB: 1
CMB: -6
...
special_abilities:
  - name: Paralyzing Slime (Ex)
    desc: Melancholic oozes are composed of chemical depressants. Any living creature that begins its turn affected by the swarm’s viscous ability must make a DC 15 Fortitude save or be paralyzed for 1 round. This is a mindaffecting effect. Creatures immune to poison are immune to this effect.
  - name: Viscous (Ex)
    desc: As described in the sanguine ooze swarm’s special abilities, except that the Reflex save DC is 15 and the patches are destroyed if the victim takes any amount of acid damage.
...
# Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Melancholic%20Ooze%20Swarm)
```encounter-table
name: Melancholic Ooze Swarm
creatures:
  - 1: Melancholic Ooze Swarm
```
