...
Monster_XP: 2400
race: Human
class: fighter (trench fighter) 6 (see page 67)
alignment: LE
size: Medium
type: undead
subtype: (augmented human, human)
INI: +8
perception: +7
senses: darkvision
...
speed: 30 ft.
melee: socket bayonet +9/+4 (1d6+3)
ranged: Mosin-Nagant M1891 rifle +12/+7 (1d10+6/×4)
special_attacks: trench warfare (rifle), weapon training (firearms +1)
pf1e_stats: [17, 18, None, 10, 12, 8]
BAB: 6
CMB: 9
CMD: 24
feats: Deadly Aim, Dodge, Improved Initiative, Point-Blank Shot, Precise Shot, Rapid Shot, Toughness, Weapon Focus (rifle), Weapon Specialization (rifle)
skills: Climb +15, Craft (firearms) +4, Knowledge (engineering) +4, Perception +7, Profession (soldier) +5, Ride +8, Stealth +10, Survival +5
racial_modifiers:
- Climb 8
languages: Russian
special_qualities: symbiote
gear:
  - name: combat
    desc: M1914 concussion grenades (2, see page 66)
  - name: other
    desc: Mosin-Nagant M1891 rifle (see page 65) with 20 metal cartridges, socket bayonet (see page 67), gas mask (see page 67)
special_abilities:
  - name: Trench Warfare (Ex)
    desc: See page 67.
  - name: Symbiote (Ex)
    desc: See above.
...
# Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Trench%20Zombie)
```encounter-table
name: Trench Zombie
creatures:
  - 1: Trench Zombie
