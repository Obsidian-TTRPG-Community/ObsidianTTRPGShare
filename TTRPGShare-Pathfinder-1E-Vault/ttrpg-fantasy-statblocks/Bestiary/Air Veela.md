...
melee: mwk dagger +13/+8 (1d4+5/19-20 plus 1d6 electricity), mwk dagger +13/+8 (1d4+5/19-20 plus 1d6 electricity)
...
ecology:
  - name: Environment
    desc: any hills or mountains (Plane of Air)
  - name: Organisation
...
spell-like_abilities:
  ...
  - name: At will
    desc: gust of wind, resist energy
  - name: 3/day
    desc: cure serious wounds, suggestion (DC 18)
  - name: 1/day
    desc: ball lightning (DC 19), dispel magic
sources:
  - name: Bestiary 5
    desc: 264
...
# Source Link
[Archives of Nethys](https://aonprd.com/MonsterDisplay.aspx?ItemName=Air%20Veela)
```encounter-table
name: Air Veela
creatures:
  - 1: Air Veela
