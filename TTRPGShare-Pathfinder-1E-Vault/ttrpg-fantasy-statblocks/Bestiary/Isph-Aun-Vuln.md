...
size: Medium
type: outsider
subtype: (chaotic, evil, extraplanar, incorporeal, qlippoth)
INI: +16
perception: +40
senses: darkvision, detect good, detect law, true seeing
aura: cloak of chaos
AC: 44, touch 32, flat-footed 31 (armor +12, deflection +9, dex +12, dodge +1)
HP: 546
HP_extra: regeneration 15; regeneration weakness lawful
HD: 28d10+392
saves: Fort +34, Ref +27, Will +31
immune: cold, death effects, mind-affecting effects, poison
resist: acid 30, electricity 30, fire 30
DR: 15/cold iron and lawful
defensive_abilities: freedom of movement, incorporeal, reflect compulsion, soul shell
SR: 36
speed: fly 100 ft. (perfect)
melee: bite +40 touch (destruction)
special_attacks: destructive commands, horrific appearance (DC 33), insidious possession, toxic storm
pf1e_stats: [None, 35, 38, 31, 28, 29]
BAB: 28
CMB: 40
CMD: 60 (can’t be tripped)
feats: Combat Casting, Combat Expertise, Combat Reflexes, Dodge, Flyby Attack, Improved Initiative, Improved Iron Will, Improved Lightning Reflexes, Iron Will, Lightning Reflexes, Mobility, Quicken Spell-Like Ability (mass suggestion), Quicken Spell-Like Ability (mind fog), Skill Focus (Bluff)
skills: Acrobatics +40, Bluff +46, Diplomacy +37, Fly +51, Intimidate +37, Knowledge (arcana) +38, Knowledge (history) +38, Knowledge (local) +38, Knowledge (nobility) +38, Knowledge (religion) +38, Knowledge (planes) +41, Perception +40, Sense Motive +40, Spellcraft +38, Stealth +43, Use Magic Device +37
...
spell-like_abilities:
  - name:
    desc: (CL 25; Concentration +34)
  - name: Constant
    desc: cloak of chaos (DC 27), detect good, detect law, freedom of movement, tongues, true seeing
  - name: At will
    desc: charm monster (DC 23), desecrate, greater command (DC 25), greater dispel magic, greater object possession (DC 26), greater teleport
  - name: 3/day
    desc: dominate monster (DC 28), greater possession (DC 27), quickened mass suggestion (DC 25), quickened mind fog (DC 24), whirlwind (DC 27)
  - name: 1/day
    desc: summon qlippoth, wish
sources:
  - name: Bestiary 6
    desc: 234
