...
pf1e_stats: [22, 14, 18, 12, 10, 8]
BAB: 9
CMB: 15
CMD: 25
feats: Cleave, Great Cleave, Lunge, Power Attack, Skill Focus (Acrobatics), Vital Strike
skills: Acrobatics +16, Climb +10, Handle Animal +10, Knowledge (nature) +5, Linguistics +3, Perception +19, Ride +5, Stealth +10, Survival +4, Swim +20
languages: Aquan, Common, Elven, Sylvan
special_qualities: elf blood, fast movement
gear:
  - name: combat
    desc: oil of align weapon (lawful), potion of cure light wounds, potion of lesser restoration, alchemical silver arrows (10), cold iron arrows (10)
  - name: other
    desc: masterwork chain shirt, +1 composite longbow (+6 Str) with 20 arrows, +1 longspear, masterwork longspear, spiked gauntlet, cloak of resistance +1, eyes of the eagle, 1 gp
sources:
  - name: NPC Codex
    desc: 14
```
