...
If the next action you use is to cast [harm](/compendium/spells/harm.md) or heal on a single target and the target regains Hit Points from the spell, it also gains a +2 status bonus to AC and saving throws for 1 round.
