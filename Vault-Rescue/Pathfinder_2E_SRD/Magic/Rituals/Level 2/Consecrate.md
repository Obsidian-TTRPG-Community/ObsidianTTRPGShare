# Consecrate
#pf/ritual/level_2
==[Uncommon](../../../Traits/Uncommon.md)== ==[Consecration](Consecration)== ==[Evocation](../../../Traits/Evocation.md)==
...
**Heightened (7th)** The consecrated area also gains the effects of the [Dimensional Lock](../../Spells/Level%207/Dimensional%20Lock.md) spell, but the effect doesn’t attempt to [counteract](../../../Rules/Counteracting.md) teleportation by worshippers of your deity. The cost increases to 200 gp × the spell level.