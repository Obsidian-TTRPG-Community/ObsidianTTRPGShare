...
abilities_bot:
  - name: "Mangling Rend"
    desc: "⬺  A megaprimatus makes two fist [[Strike|Strikes]] against the same target. If both hit, the attack deals an additional 1 (2d6) bludgeoning damage, the target is [[flat-footed|flat-footed]], and the target takes a –20-foot status penalty to all Speeds until the end of its next turn."
...
attacks:
  - name: Melee
    desc: "⬻ fist +21 ([[agile]], [[reach|reach 20 feet]]); __Damage__ 1 (2d8+10) bludgeoning"
  - name: Melee
    desc: "⬻ jaws +21 ([[reach|reach 10 feet]]); __Damage__ 1 (2d10+10) piercing"
