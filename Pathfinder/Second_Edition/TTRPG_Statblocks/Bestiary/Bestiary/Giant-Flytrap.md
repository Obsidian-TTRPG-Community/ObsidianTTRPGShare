...
abilities_bot:
  - name: "Focused Assault"
    desc: "⬺  The flytrap attacks a single target all four of its leaves. The flytrap makes one leaf [[Strike]]. On a success, the flytrap deals the damage from one leaf [[Strike]] plus an additional 1 (1d8) damage for every leaf beyond the first. On a failure, the flytrap deals the damage from one leaf [[Strike]], but it can't use [[Improved Grab]]. It deals no damage on a critical failure. This counts toward the flytrap's multiple attack penalty as a number of attacks equal to the number of leaves the flytrap has."
  - name: "Hungry Flurry"
  ...
  - name: "Swallow Whole"
    desc: "⬻ ([[attack]]);  Large, 1 (2d8+3) bludgeoning plus 1 (2d6) acid, Rupture 17."
...
attacks:
  - name: Melee
    desc: "⬻ leaf +23 ([[reach|reach 15 feet]]); __Damage__ 1 (2d8+7) piercing plus 1 (2d6) acid and [[Improved Grab]]"
