...
abilities_mid:
  ...
  - name: "Psychic Static Aura"
    desc: " ([[aura]], [[divination]], [[mental]], [[occult]]);  120 feet. All creatures, except aberrations, that begin their turn in the area take 1 (5d6) mental damage."
  - name: "Two Heads"
...
abilities_bot:
  ...
  - name: "Shell Rake"
    desc: "⬻ ([[move]]);  The baomal Swims or [[Stride|Strides]] alongside a creature or the hull of a vessel, dealing damage with the strong spikes on its shell. Each creature or ship the baomal is adjacent to at any point during its movement takes 1 (6d6+10) slashing and piercing damage (DC 42 basic Reflex save). Against vessels, Shell Rake ignores the first 5 Hardness and creates an explosion of splinters that deals 1 (3d6+5) damage to every creature within 10 feet of the deck's edge (DC 42 basic Reflex save)."
...
attacks:
  - name: Melee
    desc: "⬻ jaws +38 ([[reach|reach 20 feet]]); __Damage__ 1 (4d12+18) piercing plus [[Improved Grab]]"
  - name: Ranged
    desc: "⬻ tsunami jet +38 ([[brutal]], [[range|range 500 feet]]); __Damage__ 1 (4d10+18) bludgeoning plus Push 40 feet"
