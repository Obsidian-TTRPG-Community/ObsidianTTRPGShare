...
abilities_mid:
  - name: "Great Despair"
    desc: " ([[aura]], [[divine]], [[emotion]], [[enchantment]], [[fear]], [[incapacitation]], [[mental]]);  30 feet. As the mummy guardian's despair, except the DC is 26 and the paralysis lasts 1 (1d4) rounds."
  - name: "Rejuvenation"
    desc: " ([[divine]], [[necromancy]]);  When a mummy pharaoh is destroyed, necromantic energies rebuild its body in its tomb over 1 (1d10) days. If the re-forming body is destroyed during that time, the process starts anew. A slain mummy pharaoh can be destroyed for good with a consecrate ritual."
  - name: "Undead Mastery"
...
abilities_bot:
  ...
  - name: "Insidious Mummy Rot"
    desc: " ([[curse]], [[disease]], [[divine]], [[necromancy]]);  __Saving Throw__ DC 26 Fortitude. __Stage 1__ carrier with no ill effect (1 minute) __Stage 2__ 1 (8d6) negative damage and [[stupefied|stupefied 2]] (1 day)"
  - name: "Sandstorm Wrath"
    desc: "⬺ ([[concentrate]], [[divine]], [[evocation]], [[fire]]);  The mummy pharaoh exhales a 60-foot cone of superheated sand that deals 1 (5d6) fire and 1 (5d6) slashing damage (DC 28 basic Reflex save). The mummy pharaoh can't use Sandstorm Wrath again for 1 (1d4) rounds."
...
attacks:
  - name: Melee
    desc: "⬻ fist +20 ([[agile]]); __Damage__ 1 (1d10+11) bludgeoning plus insidious mummy rot"
  - name: Melee
    desc: "⬻ longspear +21 ([[magical]], [[reach|reach 10 feet]]); __Damage__ 1 (2d8+11) piercing plus insidious mummy rot"
