...
abilities_mid:
  - name: "Death Flood"
    desc: " ([[conjuration]], [[primal]], [[water]]);  When a grodair dies, its body explodes in a blast of pressurized water that deals 1 (4d6) bludgeoning damage to creatures within a 15-foot emanation (DC 22 basic Reflex save). A creature that fails its save is pushed 5 feet (or 10 feet on a critical failure)."
abilities_bot:
  - name: "Muddy Field"
...
attacks:
  ...
  - name: Melee
    desc: "⬻ tentacle +15 __Damage__ 1 (1d10+7) bludgeoning plus Knockdown"
  - name: Ranged
    desc: "⬻ water jet +13 ([[range increment|range increment 60 feet]]); __Damage__ 1 (3d6) bludgeoning plus Push 10 feet"
