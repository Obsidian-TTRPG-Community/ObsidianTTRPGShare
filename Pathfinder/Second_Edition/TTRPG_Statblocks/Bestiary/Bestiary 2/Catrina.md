...
abilities_bot:
  ...
  - name: "Kiss of Death"
    desc: "⬺ ([[death]], [[divine]], [[manipulate]], [[necromancy]]);  The catrina gives a long, passionate kiss to an [[unconscious|unconscious]] or willing creature, dealing 1 (3d6) negative damage. Any creature damaged by the same catrina's Kiss of Death for 3 consecutive rounds becomes [[unconscious|unconscious]] and is [[dying|dying 1]]."
  - name: "Spirit Touch"
    desc: "  An esobok's [[Strike|Strikes]] affect incorporeal creatures with the effects of a ghost touch property rune and deal 1 (1d6) negative damage to living creatures and 1 (1d6) positive damage to undead."
...
attacks:
  - name: Melee
    desc: "⬻ fist +14 ([[agile]], [[finesse]]); __Damage__ 1 (2d8+2) bludgeoning plus spirit touch"
