...
abilities_mid:
  - name: "Corrosive Surface"
    desc: "  A creature that hits a verdurous ooze with a metal weapon or unarmed attack must attempt a DC 21 Reflex save. On a failure, the weapon or creature takes 1 (2d4) acid damage (after dealing damage to the ooze as normal). Thrown weapons take this damage automatically with no save."
...
abilities_bot:
  - name: "Constrict"
    desc: "⬻  1 (2d6) bludgeoning plus 1 (1d6) acid, DC 24."
  - name: "Sleep Gas"
...
attacks:
  - name: Melee
    desc: "⬻ pseudopod +15 __Damage__ 1 (2d6+7) bludgeoning plus 1 (1d6) acid and Grab"
