...
abilities_bot:
  - name: "Breath Weapon"
    desc: "⬺ ([[cold]], [[evocation]], [[primal]]);  The fjord linnorm expels a 120-foot line of icy bile, dealing 1 (17d6) cold damage to creatures within the area (DC 37 basic Reflex save) Any creature that fails its save is covered by the ice, which freezes and fuses with the creature's skin, giving it a –10-foot penalty to Speed. A creature can [[Escape]] or [[Force Open]] the ice (DC 34) to free itself; otherwise, the ice remains for 1 minute. The fjord linnorm can't use Breath Weapon again for 1 (1d4) rounds."
  - name: "Fjord Linnorm Venom"
    desc: " ([[cold]], [[poison]]);  __Saving Throw__ DC 37 Fortitude. __Maximum Duration__ 10 rounds __Stage 1__ 1 (4d6) cold damage and [[clumsy|clumsy 1]] (1 round) __Stage 2__ 1 (6d6) cold damage and [[clumsy|clumsy 2]] (1 round)"
...
attacks:
  - name: Melee
    desc: "⬻ jaws +33 ([[magical]], [[reach|reach 20 feet]]); __Damage__ 1 (3d12+17) piercing plus fjord linnorm venom"
  - name: Melee
    desc: "⬻ claw +33 ([[agile]], [[magical]], [[reach|reach 20 feet]]); __Damage__ 1 (3d10+17) slashing"
  - name: Melee
    desc: "⬻ tail +33 ([[agile]], [[magical]], [[reach|reach 25 feet]]); __Damage__ 1 (3d6+15) bludgeoning plus [[Improved Grab]]"
