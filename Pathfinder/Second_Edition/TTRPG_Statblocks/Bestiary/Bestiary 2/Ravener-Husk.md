...
abilities_mid:
  ...
  - name: "Boneshatter"
    desc: "⬲ __Trigger__ The ravener husk takes any amount of bludgeoning damage __Effect__  The ravener's brittle bones shatter, spraying bone shards everywhere. Every creature within a 10-foot emanation of the ravener husk takes 1 (7d6) piercing damage (DC 31 basic Reflex save)."
abilities_bot:
  - name: "Breath Weapon"
    desc: "⬺ ([[divine]], [[evocation]], [[negative]]);  The ravener husk breathes a torrent of negative energy that deals 1 (16d6) negative damage in a 40-foot cone (DC 34 basic Reflex save). They can't use Breath Weapon again for 1 (1d4) rounds."
...
attacks:
  - name: Melee
    desc: "⬻ jaws +30 ([[magical]], [[reach|reach 15 feet]]); __Damage__ 1 (3d8+16) piercing plus 1 (2d6) negative"
  - name: Melee
    desc: "⬻ claw +30 ([[agile]], [[magical]], [[reach|reach 10 feet]]); __Damage__ 1 (3d4+16) slashing plus 1 (2d6) negative"
