...
abilities_bot:
  - name: "Light Pulse"
    desc: "⬺ ([[evocation]], [[light]], [[primal]], [[visual]]);  50 feet. The moonflower releases a pulse of bright light. Each non-moonflower creature in the emanation must attempt a DC 23 Fortitude save. The moonflower can't use Light Pulse again for 1 (1d4) rounds.\n__Success__ The creature is unaffected.\n__Failure__ The creature is [[dazzled|dazzled]] for 1 (1d4) rounds.\n__Critical Failure__ The creature is [[blinded|blinded]] for 1 (1d4) rounds."
  - name: "Pod Prison"
  ...
  - name: "Pod Spawn"
    desc: "  Should a Small or larger creature die within a pod prison, the pod transforms into an adult moonflower with full Hit Points after 1 (1d4) hours of growth. The newly formed moonflower has its own consciousness, but some aspect of its trunk or blossoms resembles the creature that died within. The dead creature's equipment remains inside the new moonflower and can be retrieved if the moonflower is slain."
  - name: "Swallow Whole"
    desc: "⬻ ([[attack]]);  Large, 1 (2d10+10) bludgeoning and 1 (2d6) acid, Rupture 21."
...
attacks:
  - name: Melee
    desc: "⬻ bite +20 ([[reach|reach 15 feet]]); __Damage__ 1 (2d10+10) piercing plus Grab"
  - name: Melee
    desc: "⬻ root +20 ([[agile]], [[reach|reach 15 feet]]); __Damage__ 1 (2d8+10) bludgeoning"
