...
abilities_bot:
  ...
  - name: "Thunderbolt"
    desc: "⬺ ([[electricity]], [[evocation]], [[primal]], [[sonic]]);  The living thunderclap emits a bolt of lightning that crashes with deafening thunder. The living thunderclap makes a lightning bolt [[Strike]] that deals 1 (1d12) electricity damage. If it hits, the target and any creatures within a 15-foot emanation around the target take 1 (2d6) sonic damage and must attempt a DC 18 basic Fortitude save. Any creature that fails its save is also [[deafened|deafened]] for 1 (1d4) rounds."
...
attacks:
  - name: Melee
    desc: "⬻ gust +14 ([[agile]], [[finesse]]); __Damage__ 1 (2d6+6) bludgeoning plus Push 5 feet"
  - name: Ranged
    desc: "⬻ lightning bolt +14 ([[electricity]], [[range increment|range increment 50 feet]]); __Damage__ 1 (2d12) electricity"
