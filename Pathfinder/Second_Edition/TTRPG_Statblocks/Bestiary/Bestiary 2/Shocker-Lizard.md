...
abilities_bot:
  ...
  - name: "Discharge"
    desc: "⬺ ([[electricity]]);  The shocker lizard releases a blast of lightning from its body. Creatures within a 10-foot emanation take 1 (3d6) electricity damage (DC 18 basic Reflex save). The shocker lizard can't use Discharge for 1 (1d4) rounds."
  - name: "Shocking Burst"
    desc: "⬽ ([[electricity]], [[evocation]], [[primal]]);  The shocker lizard hunkers down and begins to spark with electricity, which it releases in a 10-foot emanation that deals 1 (3d8) electricity damage (DC 18 basic Reflex save). The shocker lizard can't use."
  - name: "Shocking"
    desc: "  Burst again for 1 minute. Up to four shocker lizards can combine their Shocking Bursts. In this case, the lizards can delay the release of their electricity until any other shocker lizard within 30 feet completes its Shocking Burst. The combined Shocking Bursts create an emanation with the combined area from all participating shocker lizards. For each additional shocker lizard that joins the burst, the damage increases by 1 (3d8) and the save DC increases by 1 (to a maximum of four lizards dealing 1 (12d8) damage with a DC 21 save)."
...
attacks:
  - name: Melee
    desc: "⬻ jaws +10 ([[agile]], [[finesse]]); __Damage__ 1 (1d8+3) piercing"
  - name: Ranged
    desc: "⬻ shock +10 ([[nonlethal]], [[range increment|range increment 5 feet]]); __Damage__ 1 (2d6) electricity"
