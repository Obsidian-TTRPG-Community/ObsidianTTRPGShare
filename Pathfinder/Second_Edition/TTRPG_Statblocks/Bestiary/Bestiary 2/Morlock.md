...
abilities_bot:
  - name: "Instinctual Tinker"
    desc: "⬺  The morlock tinkers with an adjacent construct or mechanical hazard. They attempt a [[Crafting]] check against the construct's or hazard's Fortitude DC. The morlock can't succeed if the target's level is more than double the morlock's.\n__Critical Success__ The target gains 1 (4d6) HP and a +1 circumstance bonus to attack rolls for 1 minute.\n__Success__ The target gains 1 (2d6) HP.\n__Critical Failure__ The morlock injures itself, taking 1 (2d6) damage (typically bludgeoning, piercing, or slashing, but potentially a different type at the GM's discretion)."
  - name: "Leap Attack"
  ...
  - name: "Sneak Attack"
    desc: "  A morlock's [[Strike|Strikes]] deal an extra 1 (1d6) precision damage to [[flat-footed|flat-footed]] creatures."
...
attacks:
  ...
  - name: Melee
    desc: "⬻ jaws +9 ([[agile]]); __Damage__ 1 (1d4+4) piercing"
  - name: Ranged
    desc: "⬻ club +8 ([[range increment|range increment 10 feet]]); __Damage__ 1 (1d6+4) bludgeoning"
