...
abilities_mid:
  ...
  - name: "Volcanic Veins"
    desc: " ([[fire]]);  Fiery magma runs through the doprillu's veins. A creature that starts its turn [[grabbed|grabbed]] by the doprillu takes 1 (7d6) fire damage."
  - name: "Deflect Arrow"
...
attacks:
  - name: Melee
    desc: "⬻ fist +30 ([[agile]], [[magical]]); __Damage__ 1 (3d8+16) plus 1 (2d6) fire and [[Improved Grab]]"
