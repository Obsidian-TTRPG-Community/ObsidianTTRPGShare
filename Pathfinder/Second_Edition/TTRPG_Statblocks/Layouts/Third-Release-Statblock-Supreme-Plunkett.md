...
# Third Release: Supreme Plunkett
Now to focus on CSS Balancing. As you can see, if name is too long, Creature freaks out. 
...
(Minus the yellow text in traits- I was testing something)

![Supreme Plunket](_attachments/Supreme-Plunket-Test.png)
...
# Be on the lookout for Formatting and how it is formatted. Wrapping certain items in () can double up on (())'s, and all items in desc should be in a string, as should most text and properties. 
perception:
- name: Perception
